...
if __name__ == '__main__':
    ...
    save_root = os.path.join(img_save_dir, f"Vis_{args.dataset}_epoch{epoch_name}_step{step_name}_scale{args.cfg_scale}_step{sample_steps}_size{args.image_size}_bs{args.bs}_samp{args.sampling_algo}_seed{seed}")
